            ...
            {showIntervalo && (
              <div style={{ background:"#e8f0f811", border:"1px solid #1a5276", borderRadius:8, padding:16, marginBottom:16 }}>
                ...
                <div style={{ marginTop:12, display:"flex", gap:8, alignItems:"center" }}>
                  <Btn small onClick={addIntervalo} disabled={intervalo.tipo==="fixo"?!intervalo.valor:!intervalo.fracao} cor="#1a5276">✅ Gerar parcelas</Btn>
                  <Btn small outline cor="#4a4a4a" onClick={()=>setShowIntervalo(false)}>Cancelar</Btn>
                  {(intervalo.valor||intervalo.fracao) && <span style={{ fontSize:12, color:"#1a5276" }}>→ {contarParcelas()} parcela(s) serão geradas</span>}
                </div>
              </div>
            )}
